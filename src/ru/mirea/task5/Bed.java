...
public class Bed extends Furniture {
    ...
    public Bed(String modelName, double height, double width, double depth, int price,
        ...
        if(personCount <= 0 || personCount >=4)
            throw new IllegalArgumentException("An impossible number of beds for a bed: " + personCount);
    ...
    @Override
    public void jumpOn() {
        System.out.println("Jumping on the bed is fun! But how long will it last?");
    }
